...
## Quick Start
<p>Read the <a href="#" target="_blank">Mito UI documentation</a> page for information on the framework components, templates, examples, and more.</p>
...
#### Install with yarn
```bash
  yarn add @emeraldemperaur/mito-ui
```
